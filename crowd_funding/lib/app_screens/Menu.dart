...
class Menu extends StatelessWidget {
  ...
  return new Drawer(
        ...
        children: [
          ...
          new ListTile(
            ...
            onTap: () {
              Navigator.push(context, MaterialPageRoute(builder: (context)=> My_Fundraise()));
            },
          ),
        new ListTile(
         
            leading: Icon(FontAwesomeIcons.donate),
            title: new Text("My Donation",
              style: TextStyle(
                fontSize: 20,
                fontWeight: FontWeight.w400,
                color:Colors.black
            ...
            onTap: () {
              Navigator.push(context, MaterialPageRoute(builder: (context)=> My_Donation()));
            },
          ),
          new ListTile(
 ...
 class ProfileLogoImage extends StatelessWidget{
  @override
  Widget build (BuildContext context){
    AssetImage profilelogoAssetImage = AssetImage('images/profile.png');
    Image profilelogoImage = Image(image:profilelogoAssetImage);
    return Container(child: profilelogoImage,);
  }
}